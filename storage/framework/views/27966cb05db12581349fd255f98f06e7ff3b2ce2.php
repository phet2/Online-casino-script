...
<?php $__env->startSection('content'); ?>
    <div class="btn-group mb-4" role="group" aria-label="<?php echo e(__('All games')); ?>">
        <?php if(Request::get('game') == 'HeadsOrTails'): ?>
            <a href="<?php echo e(route('frontend.leaderboard', array_merge(request()->query(), ['game' => 'HeadsOrTails']))); ?>" class="btn btn-primary"><?php echo e(__('Heads or Tails')); ?></a>
        <?php elseif(Request::get('game') == 'Slots'): ?>
        ...
        <?php elseif(Request::get('game') == 'Dice 3D'): ?>
            <a href="<?php echo e(route('frontend.leaderboard', array_merge(request()->query(), ['game' => 'Dice3D']))); ?>" class="btn btn-primary"><?php echo e(__('Dice 3D')); ?></a>
        ...
        <?php elseif(Request::get('game') == 'Baccarat'): ?>
            <a href="<?php echo e(route('frontend.leaderboard', array_merge(request()->query(), ['game' => 'Baccarat']))); ?>" class="btn btn-primary"><?php echo e(__('Baccarat')); ?></a>
        <?php elseif(Request::get('game') == 'CasinoHoldem'): ?>
            <a href="<?php echo e(route('frontend.leaderboard', array_merge(request()->query(), ['game' => 'CasinoHoldem']))); ?>" class="btn btn-primary"><?php echo e(__('Casino Holdem')); ?></a>
        ...
        <div class="dropdown-menu">
            ...
            <a class="dropdown-item" href="<?php echo e(route('frontend.leaderboard', array_merge(request()->query(), ['game' => 'HeadsOrTails']))); ?>">
                <?php echo e(__('Heads or Tails')); ?>
            ...
            <a class="dropdown-item" href="<?php echo e(route('frontend.leaderboard', array_merge(request()->query(), ['game' => 'Dice3D']))); ?>">
                <?php echo e(__('Dice 3D')); ?>
            ...
            <a class="dropdown-item" href="<?php echo e(route('frontend.leaderboard', array_merge(request()->query(), ['game' => 'Baccarat']))); ?>">
                <?php echo e(__('Baccarat')); ?>

            </a>
            <?php endif; ?>
            <?php if (\Illuminate\Support\Facades\Blade::check('installed', 'game-casino-holdem')): ?>
            <a class="dropdown-item" href="<?php echo e(route('frontend.leaderboard', array_merge(request()->query(), ['game' => 'CasinoHoldem']))); ?>">
                <?php echo e(__('Casino Holdem')); ?>
